...
def createNetwork():
    G = nx.Graph()
    #Nodes
    f = open("./input/mandl1_nodes.txt", "r")
    count = 0
    nodes = []
    for line in f:
        if count > 0:
    ...
    #print(pos)
    #link
    f = open("./input/mandl1_links.txt", "r")
    count = 0
    link = []
    for line in f:
        if count > 0:
    ...
    #demand
    f = open("./input/mandl1_demand.txt", "r")
    count = 0
    demand = []
    for line in f:
        if count > 0:
...
oldpopulation = []
chromomosome = [[9,15,7,10,8,6,3,2,4,5],[13,11,10,7,15,8,6,3,2,1],[12,11,10,8,6,4,5],[14,13,11,10,8,6,3,2,1]]
